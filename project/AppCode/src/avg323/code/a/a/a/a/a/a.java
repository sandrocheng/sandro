...
public class a
{
  ...
  public a(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    label122: for (this.i = (4 + paramArrayOfByte.length); ; this.i = 4)
    {
      ...
      if (!e(paramArrayOfByte))
        break label130;
      String str = c.a(paramArrayOfByte);
  ...
  {
    if ((paramByte != 61) && ((paramByte < 0) || (paramByte >= d.length) || (d[paramByte] == -1)));
  ...
  public static byte[] a(byte[] paramArrayOfByte, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    if (paramBoolean1);
    for (a locala = new a(paramBoolean2); ; locala = new a(0, a, paramBoolean2))
    {
      paramArrayOfByte = locala.d(paramArrayOfByte);
      break;
    }
  }
  ...
  {
    return c.a(a(paramArrayOfByte, true));
  }
  ...
  private void c()
  {
    ...
    {
      return;
      byte[] arrayOfByte = new byte[2 * this.j.length];
  ...
  int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if (this.j != null)
    {
      ...
      {
        System.arraycopy(this.j, this.l, paramArrayOfByte, paramInt1, i1);
        this.l = (i1 + this.l);
        if (this.l >= this.k)
          this.j = null;
      }
  ...
  void d(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        while ((this.o) && (this.n != 0))
        {
          ...
          case 2:
            ...
            int i11 = this.k;
            this.k = (i11 + 1);
            arrayOfByte6[i11] = ((byte)(0xFF & this.p >> 16));
            break;
        ...
        label183: if ((i3 >= 0) && (i3 < d.length))
        {
          ...
          if (i4 >= 0)
          {
            ...
            if (this.n == 0)
            {
              ...
              int i6 = this.k;
              this.k = (i6 + 1);
              arrayOfByte1[i6] = ((byte)(0xFF & this.p >> 16));
              byte[] arrayOfByte2 = this.j;
              int i7 = this.k;
              this.k = (i7 + 1);
              arrayOfByte2[i7] = ((byte)(0xFF & this.p >> 8));
              byte[] arrayOfByte3 = this.j;
              int i8 = this.k;
              this.k = (i8 + 1);
              arrayOfByte3[i8] = ((byte)(0xFF & this.p));
            }
          }
        }
        i1++;
      ...
      int i9 = this.k;
      this.k = (i9 + 1);
      arrayOfByte4[i9] = ((byte)(0xFF & this.p >> 16));
      byte[] arrayOfByte5 = this.j;
      int i10 = this.k;
      this.k = (i10 + 1);
      arrayOfByte5[i10] = ((byte)(0xFF & this.p >> 8));
    }
  }
  ...
  public byte[] d(byte[] paramArrayOfByte)
  {
    ...
    while (true)
    {
      ...
      if ((a()) && (this.k < arrayOfByte.length))
      {
        ...
        System.arraycopy(arrayOfByte, 0, localObject, 0, this.k);
      }
      else
      {
