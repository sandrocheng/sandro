...
abstract class i
{
  ...
  {
    c.obtainMessage(1, new n(this, new Object[] { paramObject })).sendToTarget();
    return paramObject;
  }
  ...
  public final i a(Executor paramExecutor, Object[] paramArrayOfObject)
  {
    if (this.h != p.a);
