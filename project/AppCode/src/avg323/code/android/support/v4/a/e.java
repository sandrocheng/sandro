...
public class e
{
  ...
  {
    this.a = paramContext;
    this.e = new f(this, paramContext.getMainLooper());
  }
  ...
  public static e a(Context paramContext)
  {
    ...
    {
      if (g == null)
        g = new e(paramContext.getApplicationContext());
      e locale = g;
      return locale;
    }
  }
  ...
  private void a()
  {
    while (true)
    {
      ...
      synchronized (this.b)
      {
        ...
        if (k < localg.b.size())
        {
          ((h)localg.b.get(k)).b.onReceive(this.a, localg.a);
          k++;
        }
      }
      j++;
    ...
    while (true)
    {
      ...
      synchronized (this.b)
      {
        ...
        if (i < localArrayList1.size())
        {
          ...
          {
            if (((h)localArrayList2.get(k)).b != paramBroadcastReceiver)
              break label171;
  ...
  public void a(BroadcastReceiver paramBroadcastReceiver, IntentFilter paramIntentFilter)
  {
    synchronized (this.b)
    {
      h localh = new h(paramIntentFilter, paramBroadcastReceiver);
      ...
      synchronized (this.b)
      {
        ...
        if (localArrayList != null)
        {
          ...
          if (j >= localArrayList.size())
            break label564;
          h localh = (h)localArrayList.get(j);
          if (i != 0)
            Log.v("LocalBroadcastManager", "Matching against filter " + localh.a);
          if (localh.c)
          {
            if (i == 0)
              break label529;
          ...
          {
            m = localh.a.match(str1, str2, str3, localUri, localSet, "LocalBroadcastManager");
            if (m >= 0)
            {
              if (i != 0)
              ...
              ((ArrayList)localObject3).add(localh);
              localh.c = true;
            }
          }
        }
