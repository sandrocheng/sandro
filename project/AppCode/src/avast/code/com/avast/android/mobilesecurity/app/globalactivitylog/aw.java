 ...
 enum aw
{
  ...
  {
    return paramResources.getString(2131493964) + "\t" + paramResources.getString(2131493965, new Object[] { paramString2 });
  }
  ...
  {
    paramr.a.setImageResource(2130837771);
    paramr.c.setVisibility(0);
    paramr.c.setText(paramResources.getString(2131493964));
    paramr.d.setVisibility(0);
    paramr.d.setText(paramResources.getString(2131493965, new Object[] { paramString2 }));
  }
}

/* Location:           C:\Users\sandrocheng.21KUNPENG\Desktop\classes_dex2jar.jar
 * Qualified Name:     com.avast.android.mobilesecurity.app.globalactivitylog.aw
