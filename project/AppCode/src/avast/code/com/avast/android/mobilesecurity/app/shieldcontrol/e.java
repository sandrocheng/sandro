...
class e
  implements c
{
  e(FileShieldFragment paramFileShieldFragment)
  {
  }
  ...
  public void a(CheckBoxRow paramCheckBoxRow, boolean paramBoolean)
  {
    ...
    {
      localFileShieldFragment.a("ms-Settings", "fileWriteShield", str, 0L);
      if ((!paramBoolean) && (!FileShieldFragment.c(this.a).c()) && (!FileShieldFragment.d(this.a).c()))
 ...
 * Qualified Name:     com.avast.android.mobilesecurity.app.shieldcontrol.e
