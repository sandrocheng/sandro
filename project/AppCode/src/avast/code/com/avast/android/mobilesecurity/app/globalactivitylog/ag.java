 ...
 enum ag
{
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder().append(paramResources.getString(2131493943)).append("\t");
    ...
    {
      arrayOfObject[0] = str;
      return paramResources.getString(2131493944, arrayOfObject);
    }
  }
  ...
  public void a(Context paramContext, Resources paramResources, r paramr, String paramString1, String paramString2, String paramString3, Long paramLong1, Long paramLong2, Long paramLong3)
  {
    ...
    paramr.c.setText(paramResources.getString(2131493943));
    ...
    {
      arrayOfObject[0] = str;
      localTextView.setText(paramResources.getString(2131493944, arrayOfObject));
      return;
    }
  }
}
 ...
 * Qualified Name:     com.avast.android.mobilesecurity.app.globalactivitylog.ag
