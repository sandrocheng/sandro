 ...
 enum z
{
  ...
  {
    return paramResources.getString(2131493917) + "\t" + paramResources.getString(2131493919, new Object[] { paramString2 }) + "\t" + paramString3;
  }
  ...
  public void a(Context paramContext, Resources paramResources, r paramr, String paramString1, String paramString2, String paramString3, Long paramLong1, Long paramLong2, Long paramLong3)
  {
    ...
    paramr.c.setText(paramResources.getString(2131493917));
 ...
 * Qualified Name:     com.avast.android.mobilesecurity.app.globalactivitylog.z
