 ...
 enum af
{
  ...
  {
    return paramResources.getString(2131493941) + "\t" + paramResources.getString(2131493942, new Object[] { paramString2 }) + "\t" + paramString3;
  }
  ...
  {
    paramr.a.setImageResource(2130837753);
    paramr.c.setVisibility(0);
    paramr.c.setText(paramResources.getString(2131493941));
    paramr.d.setVisibility(0);
    paramr.d.setText(paramResources.getString(2131493942, new Object[] { paramString2 }));
  }
}

/* Location:           C:\Users\sandrocheng.21KUNPENG\Desktop\classes_dex2jar.jar
 * Qualified Name:     com.avast.android.mobilesecurity.app.globalactivitylog.af
