...
public class c extends l
{
  ...
  {
    t.a("AvastGeneric", paramContext, "Removing C2DM registration ID...");
    ae localae1 = (ae)ad.a(paramContext, ag.class);
    ae localae2 = (ae)ad.a(paramContext, ah.class);
    localae2.E();
    localae2.b();
    t.a("AvastGeneric", paramContext, "C2DM registration ID removed...");
    if (!localae1.u());
    while (true)
    {
      return;
 ...
 * Qualified Name:     com.avast.android.generic.h.c
