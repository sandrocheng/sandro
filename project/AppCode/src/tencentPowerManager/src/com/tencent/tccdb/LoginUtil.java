...
public class LoginUtil
{
  ...
  private int mCppInstance = newLoginUtilInstance();

  static
  {
    String str = TMSApplication.getStrFromEnvMap("account_login_libname");
  ...
  private native String getWapSid(int paramInt);
  ...
  public static native String makeQQPimSecureAndroidFeekBackUrl(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3);
    ...
    throws Throwable
  {
    if (this.mCppInstance != 0)
    {
      deleteLoginUtilObject(this.mCppInstance);
      this.mCppInstance = 0;
    }
  }
  ...
  {
    return getKey(this.mCppInstance);
  }

  public byte[] getPostBody()
  {
    return getPostBody(this.mCppInstance);
  }

  public String getPostUrl()
  {
    return getPostUrl(this.mCppInstance);
  }

  public String getVerifyImageUrl()
  {
    return getVerifyImageUrl(this.mCppInstance);
  }

  public String getWapSid()
  {
    return getWapSid(this.mCppInstance);
  }
  ...
  {
    throwIfError(makeLoginRequestPackage(this.mCppInstance, paramString1, paramString2, paramString3, paramString4, paramString5, paramString6, paramString7, paramString8, paramInt1, paramInt2));
  }
  ...
  {
    throwIfError(makeLoginRequestPackageMd5(this.mCppInstance, paramString1, paramString2, paramArrayOfByte1, paramArrayOfByte2, paramString3, paramString4, paramString5, paramString6, paramInt1, paramInt2));
  }

  public int solveLoginResponPackge(byte[] paramArrayOfByte, int paramInt)
  {
    return solveLoginResponPackge(this.mCppInstance, paramArrayOfByte, paramInt);
  }
}

/* Location:           C:\Users\sandrocheng.21KUNPENG\Desktop\classes_dex2jar\
 * Qualified Name:     com.tencent.tccdb.LoginUtil
