...
public final class EventRecord extends JceStruct
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if ((JceUtil.equals(this.a, localEventRecord.a)) && (JceUtil.equals(this.b, localEventRecord.b)) && (JceUtil.equals(this.c, localEventRecord.c)) && (JceUtil.equals(this.d, localEventRecord.d)) && (JceUtil.equals(this.e, localEventRecord.e)) && (JceUtil.equals(this.f, localEventRecord.f)) && (JceUtil.equals(this.g, localEventRecord.g)) && (JceUtil.equals(this.h, localEventRecord.h)));
    for (boolean bool = true; ; bool = false)
      return bool;
  }
