...
final class MultiFinderPatternFinder extends FinderPatternFinder
{
  ...
  private FinderPattern[][] selectMutipleBestPatterns()
  {
    ...
    label194: FinderPattern localFinderPattern2;
    float f1;
    do
    {
      j++;
    ...
    label279: label542: for (int m = k + 1; ; m++)
    {
      if (m >= i);
      ...
      do
      {
        ...
        if (localFinderPattern3 == null)
          break label542;
        f2 = (localFinderPattern2.getEstimatedModuleSize() - localFinderPattern3.getEstimatedModuleSize()) / Math.min(localFinderPattern2.getEstimatedModuleSize(), localFinderPattern3.getEstimatedModuleSize());
      }
      while ((Math.abs(localFinderPattern2.getEstimatedModuleSize() - localFinderPattern3.getEstimatedModuleSize()) > 0.5F) && (f2 >= 0.05F));
    ...
    label548: throw NotFoundException.getNotFoundInstance();
  }

  public final FinderPatternInfo[] findMulti(Map paramMap)
  {
    int i = 0;
    int j;
