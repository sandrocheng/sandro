...
{
  f(WipeByApp paramWipeByApp, CheckBox paramCheckBox, String paramString)
  {
  }
  ...
  public final void onClick(View paramView)
  {
    if (this.a.isChecked())
    {
      this.c.a.remove(WipeByApp.d.get(this.b));
      WipeByApp.f(this.c);
    ...
    while (true)
    {
      WipeByApp.c(this.c);
      return;
      this.c.a.add(WipeByApp.d.get(this.b));
 ...
 * Qualified Name:     org.antivirus.wipe.f
