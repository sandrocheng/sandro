...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Layj;->f:Landroid/os/Handler;

    new-instance v0, Layo;

    invoke-direct {v0, p0}, Layo;-><init>(Layj;)V

    iput-object v0, p0, Layj;->g:Landroid/os/Handler;

    return-void
.end method

.method static synthetic a(Layj;Ljava/util/List;)Ljava/util/List;
    .locals 0

    iput-object p1, p0, Layj;->mDataList:Ljava/util/List;

    return-object p1
.end method

.method static synthetic a(Layj;)Z
    .locals 1
...
.method static synthetic b(Layj;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Layj;->g:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic c(Layj;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Layj;->mHandler:Landroid/os/Handler;
...
.method private d()Lajs;
    ...
    invoke-direct {v0, p0}, Layl;-><init>(Layj;)V

    invoke-virtual {p0, v0}, Layj;->setOnRefreshListener(Lcom/tencent/qqpimsecure/uilib/view/PinnedHeaderListView$OnRefreshListener;)V
    ...
    iget-object v3, p0, Layj;->mDataList:Ljava/util/List;
...
.method static synthetic d(Layj;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Layj;->f:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic e(Layj;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic f(Layj;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic g(Layj;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic h(Layj;)Ljava/util/List;
    .locals 1

    iget-object v0, p0, Layj;->mDataList:Ljava/util/List;

    return-object v0
.end method

.method static synthetic i(Layj;)Ljava/util/List;
    .locals 1
...
.method static synthetic j(Layj;)Ljava/util/List;
    .locals 1
...
.method static synthetic k(Layj;)Ljt;
    .locals 1

    iget-object v0, p0, Layj;->a:Ljt;

    return-object v0
.end method

.method static synthetic l(Layj;)Lho;
    .locals 1

    iget-object v0, p0, Layj;->b:Lho;

    return-object v0
.end method

.method static synthetic m(Layj;)Ljava/util/List;
    .locals 1
...
.method public final a()Ljava/util/List;
    ...
    iget-object v2, p0, Layj;->mDataList:Ljava/util/List;
...
.method public final getFooterView()Landroid/view/View;
    ...
    iget-object v0, p0, Layj;->mContext:Landroid/content/Context;
...
.method public final loadDataList()V
    ...
    iget-object v8, p0, Layj;->a:Ljt;

    iget-object v0, v8, Ljt;->a:Lhs;

    iget-object v1, v8, Ljt;->c:Ljava/lang/String;
    ...
    iput-object v1, p0, Layj;->mDataList:Ljava/util/List;
    ...
    invoke-direct {v2, p0}, Laym;-><init>(Layj;)V
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Layj;->b:Lho;

    new-instance v0, Ljt;

    invoke-direct {v0}, Ljt;-><init>()V

    iput-object v0, p0, Layj;->a:Ljt;

    iget-object v0, p0, Layj;->mFooterView:Landroid/view/View;
    ...
    iput-object v0, p0, Layj;->e:Landroid/view/View;

    iget-object v0, p0, Layj;->e:Landroid/view/View;

    const/16 v1, 0x8

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, Layj;->mListView:Lcom/tencent/qqpimsecure/uilib/view/PinnedHeaderListView;
...
.method public final onHandlerMessage(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Layj;->mFooterView:Landroid/view/View;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p0}, Layj;->isHasRefreshHeader()Z
    ...
    :cond_0
    iget-object v0, p0, Layj;->mAdapter:Landroid/widget/BaseAdapter;
    ...
    const-class v2, Lcom/tencent/qqpimsecure/ui/activity/market/SoftwareCategoryDetailActivity;
...
.method public final onOptionClick(I)V
    ...
    iget-object v1, p0, Layj;->mContext:Landroid/content/Context;

    const-class v2, Lcom/tencent/qqpimsecure/ui/activity/market/SoftwareSearchActivity;

    invoke-direct {v0, v1, v2}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {p0}, Layj;->getActivity()Lcom/tencent/qqpimsecure/uilib/ui/activity/BaseUIActivity;
...
.method public final onResume()V
    ...
    invoke-virtual {p0}, Layj;->isReloadData()Z
...
.method public final onScroll(Landroid/widget/AbsListView;III)V
    ...
    invoke-virtual {p0}, Layj;->getListView()Lcom/tencent/qqpimsecure/uilib/view/PinnedHeaderListView;
...
.method public final refreshListData()V
    ...
    invoke-virtual {p0}, Layj;->getAdapter()Lcom/tencent/qqpimsecure/uilib/ui/adapter/BasePinnedListAdapter;
    ...
    invoke-virtual {p0}, Layj;->getFrameworkTemplateUI()Lcom/tencent/qqpimsecure/uilib/view/template/FrameworkTemplateUI;
    ...
    invoke-virtual {p0}, Layj;->hideEmptyView()V

    invoke-virtual {p0, v5}, Layj;->setReloadData(Z)V
