...
.method public final synthetic onReceive(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    iget-object v0, p0, Laxc;->a:Lawz;

    invoke-static {v0}, Lawz;->h(Lawz;)V

    iget-object v0, p0, Laxc;->a:Lawz;

    invoke-static {v0}, Lawz;->i(Lawz;)Landroid/os/Handler;
    ...
    iget-object v1, p0, Laxc;->a:Lawz;

    invoke-static {v1}, Lawz;->j(Lawz;)I
    ...
    invoke-static {v0}, Lawz;->k(Lawz;)Landroid/os/Handler;
    ...
    invoke-static {v0}, Lawz;->l(Lawz;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lawz;->a(Lawz;Ljava/util/List;)Ljava/util/List;

    iget-object v0, p0, Laxc;->a:Lawz;

    invoke-static {v0}, Lawz;->m(Lawz;)I
    ...
    invoke-static {v0}, Lawz;->n(Lawz;)Ljava/util/List;
    ...
    invoke-static {v0}, Lawz;->q(Lawz;)Ljt;

    move-result-object v1

    iget-object v0, p0, Laxc;->a:Lawz;

    invoke-static {v0}, Lawz;->o(Lawz;)Ljava/util/List;

    move-result-object v3

    iget-object v0, p0, Laxc;->a:Lawz;

    invoke-static {v0}, Lawz;->p(Lawz;)Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Ljz;-><init>(Ljt;Ljava/lang/String;Ljava/util/List;J)V
    ...
    invoke-static {v0}, Lawz;->r(Lawz;)Landroid/os/Handler;
