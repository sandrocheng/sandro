...
public final class cn
{
  ...
  private cn(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    label122: for (this.i = (4 + paramArrayOfByte.length); ; this.i = 4)
    {
      this.h = (-1 + this.i);
    ...
    for (byte[] arrayOfByte = c; ; arrayOfByte = b)
    {
      this.e = arrayOfByte;
      return;
    }
  ...
  private cn(boolean paramBoolean)
  {
    this(76, a, false);
  }
  ...
  private int a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (this.j != null)
      ...
      {
        i2 = this.k - this.l;
        int i3 = Math.min(i2, paramInt);
        if (this.j != paramArrayOfByte)
        {
          System.arraycopy(this.j, this.l, paramArrayOfByte, 0, i3);
          this.l = (i3 + this.l);
          if (this.l < this.k);
        }
        else
  ...
  {
    int i1 = paramInt / 4 << 2;
    long l1 = (paramArrayOfByte1.length << 2) / 3;
    long l2 = l1 % 4L;
    if (l2 != 0L)
      l1 += 4L - l2;
    int i2;
    ...
    label94: for (long l3 = l1 + paramArrayOfByte2.length; ; l3 = l1)
    {
      return l3;
      i2 = 0;
      break;
  ...
  private void a()
  {
    ...
    {
      return;
      byte[] arrayOfByte = new byte[this.j.length << 1];
    ...
    while (true)
    {
      ...
      if (paramInt2 < 0)
      {
        ...
        while (true)
        {
          ...
          int i13 = this.k;
          this.k = (i13 + 1);
          arrayOfByte9[i13] = this.e[(0x3F & this.p >> 2)];
          byte[] arrayOfByte10 = this.j;
          int i14 = this.k;
          this.k = (i14 + 1);
          arrayOfByte10[i14] = this.e[(0x3F & this.p << 4)];
          if (this.e == b)
          {
            byte[] arrayOfByte11 = this.j;
            int i15 = this.k;
            this.k = (i15 + 1);
            arrayOfByte11[i15] = 61;
            byte[] arrayOfByte12 = this.j;
            int i16 = this.k;
            this.k = (i16 + 1);
            ...
            int i9 = this.k;
            this.k = (i9 + 1);
            arrayOfByte5[i9] = this.e[(0x3F & this.p >> 10)];
            byte[] arrayOfByte6 = this.j;
            int i10 = this.k;
            this.k = (i10 + 1);
            arrayOfByte6[i10] = this.e[(0x3F & this.p >> 4)];
            byte[] arrayOfByte7 = this.j;
            int i11 = this.k;
            this.k = (i11 + 1);
            arrayOfByte7[i11] = this.e[(0x3F & this.p << 2)];
            if (this.e == b)
            {
      ...
      else
      {
        ...
        while (i1 < paramInt2)
        {
          ...
          if (this.n == 0)
          {
            ...
            int i5 = this.k;
            this.k = (i5 + 1);
            arrayOfByte1[i5] = this.e[(0x3F & this.p >> 18)];
            byte[] arrayOfByte2 = this.j;
            int i6 = this.k;
            this.k = (i6 + 1);
            arrayOfByte2[i6] = this.e[(0x3F & this.p >> 12)];
            byte[] arrayOfByte3 = this.j;
            int i7 = this.k;
            this.k = (i7 + 1);
            arrayOfByte3[i7] = this.e[(0x3F & this.p >> 6)];
            byte[] arrayOfByte4 = this.j;
            int i8 = this.k;
            this.k = (i8 + 1);
            arrayOfByte4[i8] = this.e[(0x3F & this.p)];
            this.m = (4 + this.m);
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      if (l1 > 2147483647L)
        throw new IllegalArgumentException("Input array too big, the output array would be bigger (" + l1 + ") than the specified maxium size of 2147483647");
      localcn = new cn(0, a, false);
      localcn.j = null;
      localcn.k = 0;
      localcn.l = 0;
      localcn.m = 0;
    ...
    byte[] arrayOfByte1 = new byte[(int)a(paramArrayOfByte, localcn.f, localcn.g)];
    int i1 = arrayOfByte1.length;
    if (arrayOfByte1.length == i1)
    {
      localcn.j = arrayOfByte1;
      localcn.k = 0;
      localcn.l = 0;
    }
    localcn.a(paramArrayOfByte, 0, paramArrayOfByte.length);
    localcn.a(paramArrayOfByte, 0, -1);
    if (localcn.j != arrayOfByte1)
      localcn.a(arrayOfByte1, arrayOfByte1.length);
    int i2;
    label203: byte[] arrayOfByte2;
    if (localcn.e == c)
    {
      i2 = 1;
      if ((i2 == 0) || (localcn.k >= arrayOfByte1.length))
        break label251;
      arrayOfByte2 = new byte[localcn.k];
      System.arraycopy(arrayOfByte1, 0, arrayOfByte2, 0, localcn.k);
    }
    while (true)
    {
      ...
      i2 = 0;
      break label203;
      label251: arrayOfByte2 = arrayOfByte1;
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        while ((this.o) && (this.n != 0))
        {
          ...
          case 2:
            ...
            int i11 = this.k;
            this.k = (i11 + 1);
            arrayOfByte6[i11] = ((byte)(this.p >> 16));
            break;
        ...
        label179: if ((i3 >= 0) && (i3 < d.length))
        {
          ...
          if (i4 >= 0)
          {
            ...
            if (this.n == 0)
            {
              ...
              int i6 = this.k;
              this.k = (i6 + 1);
              arrayOfByte1[i6] = ((byte)(this.p >> 16));
              byte[] arrayOfByte2 = this.j;
              int i7 = this.k;
              this.k = (i7 + 1);
              arrayOfByte2[i7] = ((byte)(this.p >> 8));
              byte[] arrayOfByte3 = this.j;
              int i8 = this.k;
              this.k = (i8 + 1);
              arrayOfByte3[i8] = ((byte)this.p);
            }
          }
        }
        i1++;
      ...
      int i9 = this.k;
      this.k = (i9 + 1);
      arrayOfByte4[i9] = ((byte)(this.p >> 16));
      byte[] arrayOfByte5 = this.j;
      int i10 = this.k;
      this.k = (i10 + 1);
      arrayOfByte5[i10] = ((byte)(this.p >> 8));
    }
  }
  ...
  public static byte[] b(byte[] paramArrayOfByte)
  {
    ...
    {
      return paramArrayOfByte;
      byte[] arrayOfByte = new byte[3 * paramArrayOfByte.length / 4];
      int i1 = arrayOfByte.length;
      if (arrayOfByte.length == i1)
      {
        localcn.j = arrayOfByte;
        localcn.k = 0;
        localcn.l = 0;
      }
      localcn.b(paramArrayOfByte, 0, paramArrayOfByte.length);
      localcn.b(paramArrayOfByte, 0, -1);
      paramArrayOfByte = new byte[localcn.k];
      localcn.a(paramArrayOfByte, paramArrayOfByte.length);
    }
  }
  ...
  private static boolean d(byte[] paramArrayOfByte)
  {
    label69: for (int i1 = 0; ; i1++)
    {
      ...
      if ((i3 != 61) && ((i3 < 0) || (i3 >= d.length) || (d[i3] == -1)));
      for (int i4 = 0; ; i4 = 1)
      {
        if (i4 == 0)
          break label69;
