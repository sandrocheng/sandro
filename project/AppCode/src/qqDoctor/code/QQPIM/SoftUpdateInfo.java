  ...
  implements Cloneable
{
  ...
  public SoftUpdateInfo(String paramString1, int paramInt1, ProductVersion paramProductVersion, int paramInt2, int paramInt3, String paramString2, String paramString3, PatchInfo paramPatchInfo, String paramString4)
  {
    setUrl(paramString1);
    setUrltype(paramInt1);
    setNewversion(paramProductVersion);
    setNew_buildno(paramInt2);
    setPkg_size(paramInt3);
    setNewfeature(paramString2);
    setMarket(paramString3);
    setPatchinfo(paramPatchInfo);
    setChecksum(paramString4);
  }
