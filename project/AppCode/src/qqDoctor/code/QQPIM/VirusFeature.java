...
public final class VirusFeature extends JceStruct
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      boolean bool2 = JceUtil.equals(this.id, localVirusFeature.id);
      bool1 = false;
      if (bool2)
      {
        boolean bool3 = JceUtil.equals(this.content, localVirusFeature.content);
        bool1 = false;
        if (bool3)
          bool1 = true;
      }
