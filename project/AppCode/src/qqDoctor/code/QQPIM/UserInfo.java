  ...
  implements Cloneable
{
  ...
  public UserInfo(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, int paramInt1, int paramInt2, ProductVersion paramProductVersion, String paramString8, String paramString9, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString10, short paramShort)
  {
    ...
    setIp(paramString4);
    setLc(paramString5);
    setChannelid(paramString6);
    setUa(paramString7);
    setCt(paramInt1);
    setProduct(paramInt2);
    setVersion(paramProductVersion);
    setGuid(paramString8);
    setImsi(paramString9);
    setIsbuildin(paramInt3);
    setIsroot(paramInt4);
    setSdkversion(paramInt5);
    setBuildno(paramInt6);
    setUuid(paramString10);
    setLang(paramShort);
  }
