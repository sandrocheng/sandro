...
public final class aon extends BaseView
  implements View.OnClickListener
{
  ...
  private Handler h = new aoo(this, this.mContext.getMainLooper());
  private NetworkLoadTaskListener<kv> i = new aop(this);

  public aon(Context paramContext)
  {
    super(paramContext, 2130903212);
  }
  ...
  {
    return new File(Environment.getExternalStorageDirectory() + File.separator + "QQSecureDownload" + File.separator + "com.tencent.powermanager.apk").exists();
  }
  ...
  public final void onClick(View paramView)
  {
    ...
    while (true)
    {
      ...
      case 2:
        ...
        break;
      case 3:
        String str = Environment.getExternalStorageDirectory() + File.separator + "QQSecureDownload" + File.separator + "com.tencent.powermanager.apk";
        if (c())
        {
          if (a.f(str))
          {
  ...
  public final void onCreate()
  {
    super.onCreate();
    this.d = new kw();
    this.d.setPackageName("com.tencent.powermanager");
    this.d.setAppName(this.mContext.getString(2131427538));
    this.d.d("http://tools.3g.qq.com/j/QQPowerManager");
  ...
  {
    paramFrameworkTemplateUI.setTitleTextData(2131427538);
