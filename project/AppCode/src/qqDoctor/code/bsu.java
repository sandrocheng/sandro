...
final class bsu
{
  ...
  bsu(Properties paramProperties, Context paramContext)
  {
  ...
  private String a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 101	bsu:d	Landroid/content/Context;
    ...
    //   61: invokestatic 159	btk:b	([B)Ljava/lang/String;
    //   64: astore 11
    //   66: aload 11
    //   68: astore 7
    //   70: aload 5
  ...
  final int a(LicenceCheckResult paramLicenceCheckResult)
  {
    return ((WupSessionManager)ManagerCreator.getManager(WupSessionManager.class)).checkLicence(new LicenceInfo(a(this.d.getPackageName()), StringUtil.assertNotNullString(TMSApplication.getStrFromEnvMap("channel"))), paramLicenceCheckResult);
  }
  ...
  public final boolean a()
  {
    ...
    while (true)
    {
      ...
      new StringBuilder("your    signature is ").append(str1).append(" len:").append(str1.length()).toString();
      new StringBuilder("licence signature is ").append(str2).append(" len:").append(str2.length()).toString();
