...
public final class SDKClient extends ISDKClient.Stub
{
  ...
  public static boolean addMessageHandler(MessageHandler paramMessageHandler)
  {
    return a.add(paramMessageHandler);
  }
  ...
  public static boolean removeMessageHandler(MessageHandler paramMessageHandler)
  {
    return a.remove(paramMessageHandler);
  }
