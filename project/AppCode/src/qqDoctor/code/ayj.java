...
public final class ayj extends blt<la>
  implements AbsListView.OnScrollListener
{
  ...
  private View e;
  private Handler f = new Handler(new ayk(this));
  private Handler g = new ayo(this);

  public ayj(Context paramContext)
  {
    super(paramContext);
  }
  ...
  private ajs d()
  {
    setOnRefreshListener(new ayl(this));
  ...
  public final void loadDataList()
  {
    ...
    {
      jt localjt = this.a;
      Cursor localCursor = localjt.a.a(localjt.c, null, null, null, null, null, null);
      ArrayList localArrayList = new ArrayList();
    ...
    else
    {
      ...
      localRequestInfo.type = 9;
      localMarketManager.fetchCategoryList(localRequestInfo, new aym(this));
      localRequestInfo.type = 3;
      localMarketManager.fetchCategoryList(localRequestInfo, new ayn(this));
    }
  ...
  public final void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      Intent localIntent = new Intent(this.mContext, SoftwareCategoryDetailActivity.class);
      ...
      localIntent.putExtra("cType", localla.k());
  ...
  public final void refreshListData()
  {
    ...
    if (getFrameworkTemplateUI() != null)
    {
      ...
      String str = this.mContext.getString(2131429788);
  ...
  {
    paramFrameworkTemplateUI.setTitleTextData(2131427997);
