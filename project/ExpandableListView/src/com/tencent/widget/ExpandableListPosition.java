...
/**
 * ExpandableListPosition can refer to either a group's position or a child's position. Referring to a child's position
 * requires both a group position (the group containing the child) and a child position (the child's position within
 * that group). To create objects, use {@link #obtainChildPosition(int, int)} or {@link #obtainGroupPosition(int)}.
 */
class ExpandableListPosition
{
    ...
    /**
     * The position of the item in the flat list (optional, used internally when the corresponding flat list position
     * for the group or child is known)
     */
    int flatListPos;
