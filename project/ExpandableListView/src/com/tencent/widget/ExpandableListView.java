...
import com.tencent.widget.ExpandableListConnector.PositionMetadata;
...
public class ExpandableListView extends ListView {
    ...
    public ExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArrayWarpper a =
            new TypedArrayWarpper(context.obtainStyledAttributes(attrs, EXPANDABLELISTVIEW_IDS, defStyle,
                    0));

        mGroupIndicator = a
                .getDrawable(EXPANDABLELISTVIEW_GROUPINDICATOR);
        mChildIndicator = a
                .getDrawable(EXPANDABLELISTVIEW_CHILDINDICATOR);
        mIndicatorLeft = a
                .getDimensionPixelSize(EXPANDABLELISTVIEW_INDICATORLEFT, 0);
        mIndicatorRight = a
                .getDimensionPixelSize(EXPANDABLELISTVIEW_INDICATORRIGHT, 0);
        if (mIndicatorRight == 0 && mGroupIndicator != null) {
            mIndicatorRight = mIndicatorLeft + mGroupIndicator.getIntrinsicWidth();
        }
        mChildIndicatorLeft = a.getDimensionPixelSize(
                EXPANDABLELISTVIEW_CHILDINDICATORLEFT, CHILD_INDICATOR_INHERIT);
        mChildIndicatorRight = a.getDimensionPixelSize(
                EXPANDABLELISTVIEW_CHILDINDICATORRIGHT, CHILD_INDICATOR_INHERIT);
        mChildDivider = a.getDrawable(EXPANDABLELISTVIEW_CHILDDIVIDER);
    ...
    public static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcel in) {
            super(in);
            this.superState = in.readParcelable(this.getClass().getClassLoader());
