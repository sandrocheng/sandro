...
public class Cryptor {
	 ...
	 * f表示加密算法，d表示解密算法 那么从plain得到crypt的过程是: crypt = f(plain &circ; preCrypt)
	 * &circ; prePlain 所以，从crypt得到plain的过程自然是 plain = d(crypt &circ; prePlain)
	 * &circ; preCrypt 此外，算法有它的填充机制，其会在明文前和明文后分别填充一定的字节数，以保证明文长度是8字节的倍数
