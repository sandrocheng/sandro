...
//		return (int)(Math.ceil(nowBrightnessValue * 100d / 255d));
	...
	public static void saveBrightness(Context context, int brightness) {
		// 亮度
		if (ScreenBrightnessDevice.isAutoBrightness(context)) {
			ScreenBrightnessDevice.stopAutoBrightness(context);
		}
//		ScreenBrightnessDevice.setBrightness((Activity) activity, brightness);
		ScreenBrightnessDevice.notifySetting(context.getContentResolver(),
				brightness);
	}
...
//		Log.i("QQDOCTOR_TEST", "set value is " + value);
		saveBrightness(this.context,value);
